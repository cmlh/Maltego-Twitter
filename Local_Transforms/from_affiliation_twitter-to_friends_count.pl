...
my $friends = $maltego_additional_field_values{"friends"};
...
print("\t<UIMessages>\n");
print(
"\t\t<UIMessage MessageType=\"Inform\">To Twitter Friends Count v$VERSION</UIMessage>\n"
);
print("\t</UIMessages>\n");
print("\t<Entities>\n");

print("\t\t<Entity Type=\"maltego.Phrase\"><Value>$friends</Value></Entity>\n");
print("\t</Entities>\n");
...
from_friends - "To Number of Twitter Friends"

=head1 VERSION

This documentation refers "To Number of Twitter Friends" Alpha v$VERSION
...
from_affiliation_twitter-to_friends_count.pl $maltego_selected_entity $maltego_additional_field_values
...
Returns the Friends Count of a Twitter Account in Malteg
